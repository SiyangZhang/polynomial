public class IntRootFactor {
    ...
    public IntRootFactor(int coefficient, int root, int base) {
    ...
    public IntRootFactor times(IntRootFactor r){
        IntRootFactor result = new IntRootFactor();
        if(this.root == r.root){
